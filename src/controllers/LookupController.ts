...
export const getSystemRoles = async (_request: Request, response: Response): Promise<void> => {
  try {
...
export const getTeamRoles = async (_request: Request, response: Response): Promise<void> => {
  try {
...
export const getStatuses = async (_request: Request, response: Response): Promise<void> => {
  try {
...
export const getPriorities = async (_request: Request, response: Response): Promise<void> => {
  try {
